import { createElement, createElementNS, generateArrayOfRandomNumbers, shuffleArray, sleep, time } from "../lib"
...
export const createSortBarsContainer = () => {
    ...
    let svgElement = createElementNS(container, "svg", "xmlns:xlink=http://www.w3.org/1999/xlink", `viewBox=0 0 ${totalWidth} ${totalHeight}`, "width=400", {
        children: [
